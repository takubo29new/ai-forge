...
{"{{topic}}について、初心者向けに3行で説明してください。"}
        ...
        <section id="usage" className="scroll-mt-6">
          ...
          <p className="text-sm text-zinc-700 dark:text-zinc-300">
            Anthropic公式の現行料金表から算出した概算コスト($)も表示します(プロンプトキャッシュ・バッチAPI等の割引は考慮していないため実際の請求額とは一致しません)。またRAG検索チャットの回答生成・チャットからのアクション解析・プロンプト改善提案はトークン数を記録していないため、Claudeの集計には含まれません。
          </p>
        </section>
